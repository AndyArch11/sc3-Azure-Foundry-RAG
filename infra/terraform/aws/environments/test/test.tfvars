...
bedrock_api_mode           = "runtime" # Set to "runtime" for real-time API calls, or "mantle" to use Bedrock Mantle for asynchronous processing (requires initial_bedrock_mantle_api_key to be set).
...
query_web_ingress_mode           = "internal"              # auto|none|internal|public ; prod auto resolves to internal
