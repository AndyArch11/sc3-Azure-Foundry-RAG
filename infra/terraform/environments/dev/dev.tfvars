...
ingestion_job_image_tag      = "202604180834-10a162e" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604181102-0c2a25a" # Immutable tag. Update when a new query-web image is pushed.
confluence_poller_image_tag  = "202604180751-43dccff" # Immutable tag. Update when a new confluence poller image is pushed.
