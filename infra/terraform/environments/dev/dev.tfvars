...
ingestion_job_image_tag      = "202604111035-3a0d5ff" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604111217-020093b" # Immutable tag. Update when a new query-web image is pushed.
