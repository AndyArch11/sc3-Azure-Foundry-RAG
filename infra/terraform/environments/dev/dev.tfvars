...
ingestion_job_image_tag      = "202604171256-f734736" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604171442-89f59cd" # Immutable tag. Update when a new query-web image is pushed.
