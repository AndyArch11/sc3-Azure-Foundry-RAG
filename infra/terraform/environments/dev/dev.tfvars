...
ingestion_job_image_tag      = "202604131330-d5d9dfb" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604131332-d5d9dfb" # Immutable tag. Update when a new query-web image is pushed.
confluence_poller_image_tag  = "202604131334-d5d9dfb" # Immutable tag. Update when a new confluence poller image is pushed.
