...
ingestion_job_image_tag      = "202604140347-3fe893d" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604140639-1f7eb83" # Immutable tag. Update when a new query-web image is pushed.
confluence_poller_image_tag  = "202604141533-8499fb2" # Immutable tag. Update when a new confluence poller image is pushed.
