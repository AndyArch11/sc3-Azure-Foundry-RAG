...
ingestion_job_image_tag      = "202604170639-0389d4a" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604170640-0389d4a" # Immutable tag. Update when a new query-web image is pushed.
confluence_poller_image_tag  = "202604170548-d520fb7" # Immutable tag. Update when a new confluence poller image is pushed.
