...
ingestion_job_image_tag      = "202604111353-f3573ef" # Immutable tag. Update when a new ingestion image is pushed.
query_web_image_tag          = "202604111508-5a4613e" # Immutable tag. Update when a new query-web image is pushed.
